    ...
    <div class="col-lg-5">
        <div class="card sticky-top" style="top: 20px;">
            ...
            <div class="card-body">
                ...
                <!-- Rekomendasi Dosen -->
                <h6 class="fw-bold mb-3">Rekomendasi Dosen:</h6>
                ...
                <form action="{{ route('admin.proposal.assign', $proposal->id) }}" method="POST">
                        ...
                        <div class="card-body">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" 
                                       name="dosen_id" value="{{ $rec->dosen->id }}" 
                                       id="dosen{{ $rec->dosen->id }}"
                                       {{ $proposal->dosen_pembimbing_id == $rec->dosen->id ? 'checked' : '' }}
                                       required>
                                <label class="form-check-label w-100" for="dosen{{ $rec->dosen->id }}">
                                    ...
                                    <small>
                                        ...
                                        Kuota: {{ $rec->dosen->getSisaKuota() }}/{{ $rec->dosen->kuota_bimbingan }}
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="catatan" class="form-control" rows="3" 
                                  placeholder="Tambahkan catatan jika diperlukan">{{ $proposal->catatan_admin }}</textarea>
                    </div>
