                ...
                <div class="card-body p-4">
                    <form action="{{ route('mahasiswa.proposal.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="abstrak" rows="8" class="form-control @error('abstrak') is-invalid @enderror"
                                placeholder="Jelaskan latar belakang masalah, tujuan penelitian, metodologi, dan hasil yang diharapkan dari penelitian Anda. Minimal 100 kata."
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="keywords"
                                class="form-control @error('keywords') is-invalid @enderror" value="{{ old('keywords') }}"
                                placeholder="Contoh: IoT, Sensor, Embedded System, Arduino, Smart Home" required>
                            @error('keywords')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                            <div class="form-text">
                                <i class="fas fa-lightbulb me-1"></i>
                                <strong>PENTING:</strong> Pisahkan dengan koma (,). Kata kunci ini akan dicocokkan dengan
                                bidang keahlian dosen untuk memberikan rekomendasi pembimbing terbaik.
                            </div>
                            ...
                            <div class="mt-2">
                                ...
                                <div class="mt-2 d-flex flex-wrap gap-2">
                                    <span class="badge bg-info px-3 py-2 rounded-pill">IoT</span>
                                    <span class="badge bg-info px-3 py-2 rounded-pill">Mobile App</span>
                                    <span class="badge bg-info px-3 py-2 rounded-pill">Web Development</span>
                                    <span class="badge bg-info px-3 py-2 rounded-pill">Machine Learning</span>
                                    <span class="badge bg-info px-3 py-2 rounded-pill">Data Mining</span>
                                    <span class="badge bg-info px-3 py-2 rounded-pill">Sistem Informasi</span>
                                    <span class="badge bg-info px-3 py-2 rounded-pill">Database</span>
                                    <span class="badge bg-info px-3 py-2 rounded-pill">AI</span>
                                    <span class="badge bg-info px-3 py-2 rounded-pill">Network Security</span>
                                </div>
                            </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="file" name="file_proposal"
                                class="form-control @error('file_proposal') is-invalid @enderror" accept=".pdf">
                            @error('file_proposal')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                            <div class="form-text">
                        ...
                        <!-- Info Box -->
                        <div class="alert"
                            style="background: linear-gradient(135deg, #E1F5FE 0%, #B3E5FC 100%); border-left: 4px solid #4FC3F7;">
                            ...
                            <p class="mb-0">
                                ...
                                dengan bidang penelitian dosen dan memberikan <strong>3-5 rekomendasi dosen pembimbing
                                    terbaik</strong>
